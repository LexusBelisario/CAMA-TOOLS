...
def select_files_and_run(root):
    ...
    try:
        ...
        for idx, row in road_gdf.iterrows():
            ...
            road_gdf.at[idx, "5km_poi"] = count
            print(f"   ↪ POIs within 5km: {count}")

        output_path = os.path.join(output_dir, "road_lines_with_5km_all_poi.shp")
...
def launch_gui():
    root = tk.Tk()
    root.title("Count All POIs within 5km of Road Midpoints")
